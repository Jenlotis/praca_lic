...
./MITObim-1.9.1/misc_scripts/downsample.py -s 4 --interleave -r ./Out1.fasta -r ./Out2.fasta | gzip > ./Downsam.fastaq.gz

#deinterlaving file
#in= input file(interlaved), out1= i out2= out files(seperated paired ends)
./BBMap_38.95/reformat.sh in=./Downsam_9.fastaq.gz out1=Down_pair1_9.fastq.gz out2=Down_pair2_9.fastq.gz 
...
mitofinder -j troch_9 -1 ./Down_pair1_9.fastq.gz -2 ./Down_pair2_9.fastq.gz -r ./ref_troch/MF491526.gb -o 5
